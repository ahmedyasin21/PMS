...
class ShopProfile(models.Model):
    ...
    shop_address = models.CharField(_("Pharmacy address"), max_length=255)
    title = models.CharField(("Pharmacy"), max_length=50)
    slug = models.SlugField(blank =True,unique = True)
    create_date = models.DateTimeField(("create date"), default=timezone.now)
    shop_category = models.ForeignKey(ShopCategory, verbose_name=_("pharmacy category"), on_delete=models.CASCADE)
    shop_bg  =models.ImageField(_("pharmacy background image"), upload_to="shop_back_grounds",default="shop_default.jpeg" ,height_field=None, width_field=None, max_length=None)
