...
class ShopRequest(models.Model):
    ...
    shop_title = models.CharField(("Pharmacy title"), max_length=50)
    shop_category = models.ForeignKey(ShopCategory, verbose_name=("Pharmacy category"), on_delete=models.CASCADE)
    shop_address = models.CharField(("Pharmacy address"), max_length=50,null=True)
    ...
    class Meta:
        verbose_name = _("Pharmacy Request")
        verbose_name_plural = _("Pharmacy Requests")
